...
const index = () => {
  ...
  const [backgroundImage, setBackgroundImage] = useState("https://www.confeiteiradesucesso.com/wp-content/uploads/2019/03/hamburguergourmet-fb.jpg")
  const [selectedIngredients, setSelectedIngredients] = useState("321")
  ...
  function Save(dados) {
    axios.post("/api/lanchs/lanchs", dados)
